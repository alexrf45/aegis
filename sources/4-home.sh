...
mkdir -p $HOME/.config && mkdir -p $HOME/.zsh && mkdir -p $HOME/.bash &&
  ...
  cp -r /home/kali/resources/bash/history $HOME/.history &&
...
cp /home/kali/resources/bash/history $HOME/.commands

cp /home/kali/resources/bash/.bashrc $HOME/.bashrc

cp /home/kali/resources/bash/.bash_profile $HOME/.bash_profile

cp /home/kali/resources/bash/aliases $HOME/.bash/aliases

cp /home/kali/resources/bash/functions.sh $HOME/.bash/functions.sh
